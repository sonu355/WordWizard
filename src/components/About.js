...
export default function About() {
    ...
    return (
        <div className=''Name='container' style={myStyle}>
                ...
                <div className="accordion-item" style={myStyle}>
                    ...
                    <div id="collapseOne" className="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                        <div className="accordion-body" style={myStyle}>
                            ...
                            that we use to style each element. These  control the overall appearance, 
                            ...
                            any HTML can go within the accordion-body, though the transition does limit overflow.
                        </div>
                    </div>
                </div>
                <div className="accordion-item" style={myStyle}>
                ...
                <div className="accordion-item" style={myStyle}>
                    ...
                    <div id="collapseThree" className="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                        <div className="accordion-body" style={myStyle}>
                            ...
                            It is hidden by default, until the collapse plugin adds the appropriate  
                            that we use to style each element. These  control the overall appearance, as 
            ...
            <button onClick={toggleTheme} className='btn btn-dark m-3'>{btnText}</button>
        </div>
    )
}
